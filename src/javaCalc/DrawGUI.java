...
class DrawGUI extends JFrame
{
   ...
   JButton btnCalculate = new
      JButton("Calculate Grade");
   JButton btnReset = new JButton("Reset");

   JRadioButton radEnglish = new
      JRadioButton("English Student",true);
   JRadioButton radMath = new
      JRadioButton("Math Student",false);
   JRadioButton radScience = new
      JRadioButton("Science Student",false);

   JLabel lblMidterm = new
      JLabel("Midterm",JLabel.CENTER);
   JLabel lblFinalExam = new
      JLabel("Final Exam",JLabel.CENTER);
   JLabel lblResearch = new
      JLabel("Research Paper",JLabel.CENTER);
   JLabel lblPresentation = new
      JLabel("Presentation",JLabel.CENTER);
   JLabel lblTypes = new
      JLabel("Student Types",JLabel.CENTER);
   JLabel lblGrades = new
      JLabel("Grades",JLabel.CENTER);
   JLabel lblStudentType = new
      JLabel("ENGLISH STUDENT",JLabel.CENTER);
   JLabel lblFinalGrade = new
   ...
   RadioButtonListener rbListener =
   	new RadioButtonListener(this);
   CalculateButtonListener cbListener =
   	new CalculateButtonListener(this);
   ResetButtonListener resetListener =
   	new ResetButtonListener(this);
